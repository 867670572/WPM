...
- (id)init{
    ...
    if (self) {
        ...
        for (int i = 0; i<arrDate.count; i++) {
            WPMAlbum *album = [[WPMAlbum alloc] initWithDate:[arrDate objectAtIndex:i] withDiary:[arrDiary objectAtIndex:i] withDiaryImgName:[arrImageName objectAtIndex:i] withStatus:[arrStatus objectAtIndex:i]];
